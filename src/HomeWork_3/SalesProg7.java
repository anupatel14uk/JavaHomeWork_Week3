package HomeWork_3;
/*Write a java program input sales id, seller's name, sales amount, and
 salary basic and then fined this sales
...
public class SalesProg7 {

    public static void main(String[] args) {
        SalesProg7 salesProg7 = new SalesProg7();
